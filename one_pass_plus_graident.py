...
if __name__ == "__main__":
    ...
    for j in range(32):
        ...
        save_model_parameters(minimum_model, model_string, f'one_pass_grad_round_{j}', 'D:\\pass_gradient_exp\\regression', global_device)
        save_model_parameters(model_copy, model_string, f'just_grad_round_{j}', 'D:\\pass_gradient_exp\\regression', global_device)
    ...
    gathered_data.to_csv("D:\\pass_gradient_exp\\stats.csv", index=False)
    plt.show()
